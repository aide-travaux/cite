...
use AideTravaux\CITE\Database\ENV\CITEENV06;
use AideTravaux\CITE\Model\DataInterface;

class CITEENV06Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITEENV06::getMontantForfaitaire($stub)));
        $this->assertEquals(CITEENV06::getMontantForfaitaire($stub), $expect);
    }

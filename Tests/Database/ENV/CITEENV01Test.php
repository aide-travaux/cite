...
use AideTravaux\CITE\Database\ENV\CITEENV01;
use AideTravaux\CITE\Model\DataInterface;

class CITEENV01Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITEENV01::getMontantForfaitaire($stub)));
        $this->assertEquals(CITEENV01::getMontantForfaitaire($stub), $expect);
    }

...
use AideTravaux\CITE\Database\ENV\ENV01;
use AideTravaux\CITE\Model\DataInterface;

class ENV01Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(ENV01::getMontantForfaitaire($stub)));
        $this->assertEquals(ENV01::getMontantForfaitaire($stub), $expect);
    }

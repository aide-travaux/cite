...
use AideTravaux\CITE\Database\ENV\CITEENV05;
use AideTravaux\CITE\Model\DataInterface;

class CITEENV05Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITEENV05::getMontantForfaitaire($stub)));
        $this->assertEquals(CITEENV05::getMontantForfaitaire($stub), $expect);
    }

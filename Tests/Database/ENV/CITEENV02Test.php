...
use AideTravaux\CITE\Database\ENV\CITEENV02;
use AideTravaux\CITE\Model\DataInterface;

class CITEENV02Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITEENV02::getMontantForfaitaire($stub)));
        $this->assertEquals(CITEENV02::getMontantForfaitaire($stub), $expect);
    }

...
use AideTravaux\CITE\Database\SE\SE03;
use AideTravaux\CITE\Model\DataInterface;

class SE03Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(SE03::getMontantForfaitaire($stub)));
        $this->assertEquals(SE03::getMontantForfaitaire($stub), $expect);
    }

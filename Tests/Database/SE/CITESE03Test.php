...
use AideTravaux\CITE\Database\SE\CITESE03;
use AideTravaux\CITE\Model\DataInterface;

class CITESE03Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITESE03::getMontantForfaitaire($stub)));
        $this->assertEquals(CITESE03::getMontantForfaitaire($stub), $expect);
    }

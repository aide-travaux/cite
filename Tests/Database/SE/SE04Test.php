...
use AideTravaux\CITE\Database\SE\SE04;
use AideTravaux\CITE\Model\DataInterface;

class SE04Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(SE04::getMontantForfaitaire($stub)));
        $this->assertEquals(SE04::getMontantForfaitaire($stub), $expect);
    }

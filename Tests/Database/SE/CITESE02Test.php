...
use AideTravaux\CITE\Database\SE\CITESE02;
use AideTravaux\CITE\Model\DataInterface;

class CITESE02Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITESE02::getMontantForfaitaire($stub)));
        $this->assertEquals(CITESE02::getMontantForfaitaire($stub), $expect);
    }

...
use AideTravaux\CITE\Database\SE\CITESE01;
use AideTravaux\CITE\Model\DataInterface;

class CITESE01Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITESE01::getMontantForfaitaire($stub)));
        $this->assertEquals(CITESE01::getMontantForfaitaire($stub), $expect);
    }

...
use AideTravaux\CITE\Database\TH\CITETH02;
use AideTravaux\CITE\Model\DataInterface;

class CITETH02Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITETH02::getMontantForfaitaire($stub)));
        $this->assertEquals(CITETH02::getMontantForfaitaire($stub), $expect);
    }

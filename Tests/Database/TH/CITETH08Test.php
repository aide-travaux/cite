...
use AideTravaux\CITE\Database\TH\CITETH08;
use AideTravaux\CITE\Model\DataInterface;

class CITETH08Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITETH08::getMontantForfaitaire($stub)));
        $this->assertEquals(CITETH08::getMontantForfaitaire($stub), $expect);
    }

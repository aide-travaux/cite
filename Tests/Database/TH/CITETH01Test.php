...
use AideTravaux\CITE\Database\TH\CITETH01;
use AideTravaux\CITE\Model\DataInterface;

class CITETH01Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITETH01::getMontantForfaitaire($stub)));
        $this->assertEquals(CITETH01::getMontantForfaitaire($stub), $expect);
    }

...
use AideTravaux\CITE\Database\TH\TH12;
use AideTravaux\CITE\Model\DataInterface;

class TH12Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(TH12::getMontantForfaitaire($stub)));
        $this->assertEquals(TH12::getMontantForfaitaire($stub), $expect);
    }

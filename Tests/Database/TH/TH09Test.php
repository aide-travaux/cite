...
use AideTravaux\CITE\Database\TH\TH09;
use AideTravaux\CITE\Model\DataInterface;

class TH09Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(TH09::getMontantForfaitaire($stub)));
        $this->assertEquals(TH09::getMontantForfaitaire($stub), $expect);
    }

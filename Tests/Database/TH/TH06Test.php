...
use AideTravaux\CITE\Database\TH\TH06;
use AideTravaux\CITE\Model\DataInterface;

class TH06Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(TH06::getMontantForfaitaire($stub)));
        $this->assertEquals(TH06::getMontantForfaitaire($stub), $expect);
    }

...
use AideTravaux\CITE\Database\TH\CITETH05;
use AideTravaux\CITE\Model\DataInterface;

class CITETH05Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITETH05::getMontantForfaitaire($stub)));
        $this->assertEquals(CITETH05::getMontantForfaitaire($stub), $expect);
    }

...
use AideTravaux\CITE\Database\TH\CITETH03;
use AideTravaux\CITE\Model\DataInterface;

class CITETH03Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITETH03::getMontantForfaitaire($stub)));
        $this->assertEquals(CITETH03::getMontantForfaitaire($stub), $expect);
    }

...
use AideTravaux\CITE\Database\TH\CITETH06;
use AideTravaux\CITE\Model\DataInterface;

class CITETH06Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITETH06::getMontantForfaitaire($stub)));
        $this->assertEquals(CITETH06::getMontantForfaitaire($stub), $expect);
    }

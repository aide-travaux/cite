...
use AideTravaux\CITE\Database\TH\CITETH09;
use AideTravaux\CITE\Model\DataInterface;

class CITETH09Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITETH09::getMontantForfaitaire($stub)));
        $this->assertEquals(CITETH09::getMontantForfaitaire($stub), $expect);
    }

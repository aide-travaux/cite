...
use AideTravaux\CITE\Database\TH\CITETH12;
use AideTravaux\CITE\Model\DataInterface;

class CITETH12Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITETH12::getMontantForfaitaire($stub)));
        $this->assertEquals(CITETH12::getMontantForfaitaire($stub), $expect);
    }

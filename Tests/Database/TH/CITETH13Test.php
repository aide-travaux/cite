...
use AideTravaux\CITE\Database\TH\CITETH13;
use AideTravaux\CITE\Model\DataInterface;

class CITETH13Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITETH13::getMontantForfaitaire($stub)));
        $this->assertEquals(CITETH13::getMontantForfaitaire($stub), $expect);
    }

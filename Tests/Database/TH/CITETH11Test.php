...
use AideTravaux\CITE\Database\TH\CITETH11;
use AideTravaux\CITE\Model\DataInterface;

class CITETH11Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(CITETH11::getMontantForfaitaire($stub)));
        $this->assertEquals(CITETH11::getMontantForfaitaire($stub), $expect);
    }

...
use AideTravaux\CITE\Database\TH\TH08;
use AideTravaux\CITE\Model\DataInterface;

class TH08Test extends TestCase
{
    /**
    ...
    public function testGetMontantForfaitaire($model, $expect)
    {
        ...
        $this->assertTrue(\is_int(TH08::getMontantForfaitaire($stub)));
        $this->assertEquals(TH08::getMontantForfaitaire($stub), $expect);
    }

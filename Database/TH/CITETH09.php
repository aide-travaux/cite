...
abstract class CITETH09 implements DBInterface
{
    use DBTrait;
     ...
     * @property
     */
    const NOM = 'Partie thermique d\'un équipement PVT eau (système hybride photovoltaïque et thermique)';

    /**
     * @property
     */
    const CODE = 'CITE-TH-09';
